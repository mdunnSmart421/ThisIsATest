...
<div class="innerContentGrid">
	...
	<div class="bodyHdr01Text">
		<h1>Portal Account should be associated with a valid MSISDN</h1>
	</div>
	...
	<div class="module6Box noBorder noMargin">	
		...
		<div class="module23Box">
                    ...
                    <p>Error FW103 - The MyO2 account you're trying to register with doesn't have a mobile number associated to it. Please click <a id="here1" href="https://registration.o2.co.uk/Registration/Update">here</a> to add a mobile number. Once you’ve done that, click <a id="here2" href="https://www.o2.co.uk/money/wallet/registerapply">here</a> to start your O2 Wallet registration again, then close this page.</p>
		  	  		</div>
