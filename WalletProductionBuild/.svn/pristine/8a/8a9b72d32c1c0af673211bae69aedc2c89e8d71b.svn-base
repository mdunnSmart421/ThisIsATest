 ...
 * 
 */
public class TestingUpdateUserController extends SimpleFormController
{
    Logger log = LogManager.getLogger(this.getClass().getName());

    /**
     * On form submission, automatically transfer to view CONFIRM_PRODUCT_APPLICATION
     * 
     * @param command
     * @return
     * @throws Exception
    ...
    protected ModelAndView onSubmit(Object command) throws Exception
    {
        ...
        //
        log.debug("onSubmit.");
        return new ModelAndView(NavigationConstants.CONFIRM_PRODUCT_APPLICATION);
    }
}