...
<div class="innerContentGrid">
	...
	<div class="module6Box noBorder noMargin">	
		...
		<div class="module23Box">
                    ...
                    Error FW101 - You're session has timed out. Please click <a id="here" href="https://www.o2.co.uk/money/wallet/registerapply">here</a> to start your O2 Wallet registration again.
		  	  		</div>
